  ...
  config = lib.mkIf cfg.enable {
    ...
    az.server.rke2.images = {
      pg-14 = {
        ...
        finalImageTag = "14.20";
        imageDigest = "sha256:cb932476d5a286556daaf3b24a9eb36ab6d716ee97311515222183a7f98a2371";
        hash = "sha256-pZ42KKn9FRKuXX5q7L7fP/RKNpIrMJG445DWp9maPT0="; # renovate: ghcr.io/cloudnative-pg/postgresql 14.20
      };
      pg-15 = {
        imageName = "ghcr.io/cloudnative-pg/postgresql";
        finalImageTag = "15.15";
        imageDigest = "sha256:fa8206692a983b636f0db51416657692c2fef5e1cf29d36ba2c9bf9773cdba9a";
        hash = "sha256-l/pKXy1B6onC4KA5u/5+boi6Rg7/yOx1VkoAT3wxy9c="; # renovate: ghcr.io/cloudnative-pg/postgresql 15.15
      };
      pg-16 = {
        imageName = "ghcr.io/cloudnative-pg/postgresql";
        finalImageTag = "16.11";
