  ...
  config = lib.mkIf (domains != {}) {
    ...
    az.server.rke2.images = {
      ...
      nginx = {
        ...
        finalImageTag = "1.29";
        imageDigest = "sha256:74d864843f59c0492fa7ba0eb8ff9b2b6b4797b069e4bfee78df6739873eebd7";
        hash = "sha256-tYT6TOeqb/UERYAUNXoi8PNg49fxUuNLXgNYG0dCgyI="; # renovate: nginxinc/nginx-unprivileged 1.29
      };
    };
