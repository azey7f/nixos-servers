{pkgs, ...}: {
  # args: oci://ghcr.io/prometheus-community/charts/kube-prometheus-stack --version 77.14.0
  config.services.rke2.images = builtins.map pkgs.dockerTools.pullImage [
    ...
    }
    {
      ...
      imageDigest = "sha256:a1701c2180249361737a99a01bc770db39381640e4d631825d38ff4535efa47d";
      hash = "sha256-T9Dya/1ajtlvQUnOjsEBprWjg6prgeHZh+vn8TfiMtM=";
      finalImageTag = "12.1.1";
    }
    {
    ...
    }
    {
      ...
      imageDigest = "sha256:890b3bb05cf4ed81541922c611de8805ec9f5c1428017738a8e64e9189350e80";
      hash = "sha256-19OlY/e3YrWf6frD77iCMbG8tE9UCFcR8vlRYfRmGro=";
      finalImageTag = "v0.85.0";
    }
    {
